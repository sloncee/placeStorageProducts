...
class ServiceWithoutCatchTest {
    @Test
    void testProcessWarehouseAddProduct_Positive() throws CheckedWarehouseAddProductException {
        ...
        assertDoesNotThrow(() -> service1.processWarehouseAddProduct(bookWarehouse1, product1, 0));
    }
    ...
    void testProcessWarehouseAddProduct_Negative() {
        ...
        assertThrows(CheckedWarehouseAddProductException.class, () -> service2.processWarehouseAddProduct(bookWarehouse2, product2, 5));
    }
    ...
    void testProcessProductOnStackPrice_Negative() {
        // продукт с неположительной ценой
        ...
        ServiceWithoutCatch service2 = new ServiceWithoutCatch();
        assertThrows(UncheckedProductOnStackPriceException.class, () -> service2.processProductOnStackPrice(productOnStack));
    }
}
